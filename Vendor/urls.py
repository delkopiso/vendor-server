...
urlpatterns = patterns('',
    ...
    url(r'^regions/(?P<region>[a-z]+)/articles/(?P<sectionA>[a-z]+)/$', 'vendorApp.views.get_region_section', name='politics'),
    url(r'^regions/(?P<region>[a-z]+)/articles/(?P<sectionA>[a-z]+)/(?P<sectionB>[a-z]+)/(?P<sectionC>[a-z]+)/$', 'vendorApp.views.get_region_section_articles'),
